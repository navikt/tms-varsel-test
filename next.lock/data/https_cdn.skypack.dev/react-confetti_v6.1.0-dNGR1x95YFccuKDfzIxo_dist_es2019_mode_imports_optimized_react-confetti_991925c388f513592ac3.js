...
var reactConfetti_min = createCommonjsModule(function(module, exports) {
  !function(t, e) {
    module.exports = e(require$$0);
  }(typeof self != "undefined" ? self : commonjsGlobal, function(t) {
    return function(t2) {
      var e = {};
      function n(r) {
        if (e[r])
      ...
      return n.m = t2, n.c = e, n.d = function(t3, e2, r) {
        ...
        if (n.r(r), Object.defineProperty(r, "default", {enumerable: true, value: t3}), 2 & e2 && typeof t3 != "string")
          for (var i in t3)
            n.d(r, i, function(e3) {
              return t3[e3];
            }.bind(null, i));
      ...
      var r = {linear: function(t3, e2, n2, r2) {
        ...
        return t3 == 0 ? e2 : (n2 - e2) * Math.pow(2, 10 * (t3 / r2 - 1)) + e2;
      }, easeOutExpo: function(t3, e2, n2, r2) {
        var i = n2 - e2;
        return t3 == r2 ? e2 + i : i * (1 - Math.pow(2, -10 * t3 / r2)) + e2;
      }, easeInOutExpo: function(t3, e2, n2, r2) {
        var i = n2 - e2;
        return t3 === 0 ? e2 : t3 === r2 ? e2 + i : (t3 /= r2 / 2) < 1 ? i / 2 * Math.pow(2, 10 * (t3 - 1)) + e2 : i / 2 * (2 - Math.pow(2, -10 * --t3)) + e2;
        ...
        var i, o, a, c = n2 - e2;
        return a = 1.70158, t3 === 0 ? e2 : (t3 /= r2) == 1 ? e2 + c : ((o = 0) || (o = 0.3 * r2), (i = c) < Math.abs(c) ? (i = c, a = o / 4) : a = o / (2 * Math.PI) * Math.asin(c / i), -i * Math.pow(2, 10 * (t3 -= 1)) * Math.sin((t3 * r2 - a) * (2 * Math.PI) / o) + e2);
      }, easeOutElastic: function(t3, e2, n2, r2) {
        var i, o, a, c = n2 - e2;
        return a = 1.70158, t3 === 0 ? e2 : (t3 /= r2) == 1 ? e2 + c : ((o = 0) || (o = 0.3 * r2), (i = c) < Math.abs(c) ? (i = c, a = o / 4) : a = o / (2 * Math.PI) * Math.asin(c / i), i * Math.pow(2, -10 * t3) * Math.sin((t3 * r2 - a) * (2 * Math.PI) / o) + c + e2);
      }, easeInOutElastic: function(t3, e2, n2, r2) {
        var i, o, a, c = n2 - e2;
        return a = 1.70158, t3 === 0 ? e2 : (t3 /= r2 / 2) == 2 ? e2 + c : ((o = 0) || (o = r2 * (0.3 * 1.5)), (i = c) < Math.abs(c) ? (i = c, a = o / 4) : a = o / (2 * Math.PI) * Math.asin(c / i), t3 < 1 ? i * Math.pow(2, 10 * (t3 -= 1)) * Math.sin((t3 * r2 - a) * (2 * Math.PI) / o) * -0.5 + e2 : i * Math.pow(2, -10 * (t3 -= 1)) * Math.sin((t3 * r2 - a) * (2 * Math.PI) / o) * 0.5 + c + e2);
      }, easeInBack: function(t3, e2, n2, r2, i) {
        return i === void 0 && (i = 1.70158), (n2 - e2) * (t3 /= r2) * t3 * ((i + 1) * t3 - i) + e2;
      }, easeOutBack: function(t3, e2, n2, r2, i) {
        return i === void 0 && (i = 1.70158), (n2 - e2) * ((t3 = t3 / r2 - 1) * t3 * ((i + 1) * t3 + i) + 1) + e2;
      }, easeInOutBack: function(t3, e2, n2, r2, i) {
        var o = n2 - e2;
        return i === void 0 && (i = 1.70158), (t3 /= r2 / 2) < 1 ? o / 2 * (t3 * t3 * ((1 + (i *= 1.525)) * t3 - i)) + e2 : o / 2 * ((t3 -= 2) * t3 * ((1 + (i *= 1.525)) * t3 + i) + 2) + e2;
      ...
      var l = function() {
        function t3(e3, n3, r2, o2) {
          ...
          this.context = e3, this.x = r2, this.y = o2, this.w = u(5, 20), this.h = u(5, 20), this.radius = u(5, 10), this.vx = typeof l2 == "number" ? u(-l2, l2) : u(l2.min, l2.max), this.vy = typeof p2 == "number" ? u(-p2, 0) : u(p2.min, p2.max), this.shape = (a2 = 0, c2 = 2, Math.floor(a2 + Math.random() * (c2 - a2 + 1))), this.angle = u(0, 360) * Math.PI / 180, this.angularSpin = u(-0.2, 0.2), this.color = f2[Math.floor(Math.random() * f2.length)], this.rotateY = u(0, 1), this.rotationDirection = u(0, 1) ? i.Positive : i.Negative;
        }
        var e2, n2;
        return e2 = t3, (n2 = [{key: "update", value: function() {
          var t4 = this.getOptions(), e3 = t4.gravity, n3 = t4.wind, o2 = t4.friction, a2 = t4.opacity, c2 = t4.drawShape;
          this.x += this.vx, this.y += this.vy, this.vy += e3, this.vx += n3, this.vx *= o2, this.vy *= o2, this.rotateY >= 1 && this.rotationDirection === i.Positive ? this.rotationDirection = i.Negative : this.rotateY <= -1 && this.rotationDirection === i.Negative && (this.rotationDirection = i.Positive);
          var s2 = 0.1 * this.rotationDirection;
          if (this.rotateY += s2, this.angle += this.angularSpin, this.context.save(), this.context.translate(this.x, this.y), this.context.rotate(this.angle), this.context.scale(1, this.rotateY), this.context.rotate(this.angle), this.context.beginPath(), this.context.fillStyle = this.color, this.context.strokeStyle = this.color, this.context.globalAlpha = a2, this.context.lineCap = "round", this.context.lineWidth = 2, c2 && typeof c2 == "function")
      ...
      var O = {width: typeof window != "undefined" ? window.innerWidth : 300, height: typeof window != "undefined" ? window.innerHeight : 200, numberOfPieces: 200, friction: 0.99, wind: 0, gravity: 0.1, initialVelocityX: 4, initialVelocityY: 10, colors: ["#f44336", "#e91e63", "#9c27b0", "#673ab7", "#3f51b5", "#2196f3", "#03a9f4", "#00bcd4", "#009688", "#4CAF50", "#8BC34A", "#CDDC39", "#FFEB3B", "#FFC107", "#FF9800", "#FF5722", "#795548"], opacity: 1, debug: false, tweenFunction: s.a.easeInOutQuad, tweenDuration: 5e3, recycle: true, run: true}, w = function() {
        function t3(e3, n3) {
          ...
          !function(t4, e4) {
            ...
            var e4 = {confettiSource: {x: 0, y: 0, w: r2.canvas.width, h: 0}};
            r2._options = d(d(d({}, e4), O), t4), Object.assign(r2, t4.confettiSource);
          }), g(this, "update", function() {
            var t4 = r2.options, e4 = t4.run, n4 = t4.onConfettiComplete, i3 = r2.canvas, o2 = r2.context;
            e4 && (o2.fillStyle = "white", o2.clearRect(0, 0, i3.width, i3.height)), r2.generator.animate() ? r2.rafId = requestAnimationFrame(r2.update) : (n4 && typeof n4 == "function" && r2.generator.particlesGenerated > 0 && n4.call(r2, r2), r2._options.run = false);
          }), g(this, "reset", function() {
            r2.generator && r2.generator.particlesGenerated > 0 && (r2.generator.particlesGenerated = 0, r2.generator.particles = [], r2.generator.lastNumberOfPieces = 0);
          }), g(this, "stop", function() {
            r2.options = {run: false}, r2.rafId && (cancelAnimationFrame(r2.rafId), r2.rafId = void 0);
          }), this.canvas = e3;
          var i2 = this.canvas.getContext("2d");
          if (!i2)
            throw new Error("Could not get canvas context");
        ...
        return e2 = t3, (n2 = [{key: "options", get: function() {
          ...
          this.setOptionsWithDefaults(t4), this.generator && (Object.assign(this.generator, this.options.confettiSource), typeof t4.recycle == "boolean" && t4.recycle && n3 === false && (this.generator.lastNumberOfPieces = this.generator.particles.length)), typeof t4.run == "boolean" && t4.run && e3 === false && this.update();
        }}]) && b(e2.prototype, n2), t3;
      }();
      function m(t3) {
        return function(t4) {
          if (Array.isArray(t4))
      ...
      function S(t3, e2) {
        if (t3) {
          ...
          return n2 === "Object" && t3.constructor && (n2 = t3.constructor.name), n2 === "Map" || n2 === "Set" ? Array.from(t3) : n2 === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n2) ? C(t3, e2) : void 0;
        }
      }
      function C(t3, e2) {
      ...
      function k(t3, e2) {
        return !e2 || x(e2) !== "object" && typeof e2 != "function" ? A(t3) : e2;
      }
      function A(t3) {
        if (t3 === void 0)
      ...
      var B = a.a.createRef(), N = function(t3) {
        ...
        function o2(t4) {
          var e3;
          D(this, o2);
          for (var n3 = arguments.length, r2 = new Array(n3 > 1 ? n3 - 1 : 0), c2 = 1; c2 < n3; c2++)
            r2[c2 - 1] = arguments[c2];
          return T(A(e3 = i2.call.apply(i2, [this, t4].concat(r2))), "canvas", a.a.createRef()), T(A(e3), "confetti", void 0), e3.canvas = t4.canvasRef || B, e3;
        }
        return e2 = o2, (n2 = [{key: "componentDidMount", value: function() {
          ...
          var t4 = I(q(this.props), 2), e3 = t4[0], n3 = t4[1], r2 = M({zIndex: 2, position: "absolute", pointerEvents: "none", top: 0, left: 0, bottom: 0, right: 0}, n3.style);
          return a.a.createElement("canvas", P({width: e3.width, height: e3.height, ref: this.canvas}, n3, {style: r2}));
        }}]) && E(e2.prototype, n2), o2;
      }(o.Component);
      function q(t3) {
...
var __pika_web_default_export_for_treeshaking__ = /* @__PURE__ */ getDefaultExportFromCjs(reactConfetti_min);
var ReactConfetti = reactConfetti_min.ReactConfetti;
export default __pika_web_default_export_for_treeshaking__;
export {ReactConfetti, reactConfetti_min as __moduleExports};
